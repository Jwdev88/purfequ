    ...
    <div className="my-10">
      <div className="text-center text-3x1 py-8">
        ...
        <p className="w-3/4 m-auto text-xs sm:text-sm md:text-base text-gray-600">
          ...
          facilis modi atque laboriosam. Laborum quidem voluptates quibusdam
          adipisci obcaecati expedita, alias recusandae porro ducimus dolore
          nihil eaque nam consequatur?
        </p>
      </div>
